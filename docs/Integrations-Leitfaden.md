...
> anbinden**. Er ergänzt das [Integrations-Konzept](Integrations-Konzept-Externe-Anbindung.md)
> (Architektur, Leitplanken, Regeln) um konkrete **Rezepte, Endpunkt-Referenzen und
> Beispiel-Aufrufe**. Sicherheit/Identitäten: [Auth-Konzept](Auth-Konzept.md).
>
